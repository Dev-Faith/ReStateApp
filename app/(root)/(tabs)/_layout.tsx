...
const TabIcon = ({
  ...
  return (
    <View className="flex-1 mt-3 flex flex-col items-center">
      ...
      <Text className={`${focused ? "text-primary-300 font-rubik-medium": "text-black-200 font-rubik"} text-xm w-full text-center mt-1`}>
        {title}
      </Text>
    </View>
  );
    ...
    >
      ...
      <Tabs.Screen
        ...
        options={{
          ...
          headerShown: false,
          tabBarIcon: ({ focused }: { focused: boolean }) => {
            return <TabIcon icon={icons.search} title="Explore" focused={focused} />;
          },
        }}
      />
      <Tabs.Screen
